...
const totalRaisedGame = GAMES_JSON.reduce((sum, game) => sum + game.pledged, 0);

// Total number of games
const totalGames = GAMES_JSON.length;

// Filter the unfunded games
const unfundedGames = GAMES_JSON.filter(game => game.pledged < game.goal);
...
const displayStr = `A total of $${totalRaisedGame.toLocaleString()} has been raised for ${totalGames} games. Currently, ${numUnfundedGames} ${numUnfundedGames === 1 ? "game" : "games"} remain unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const unfundedGamesElement = document.createElement('p');
unfundedGamesElement.innerText = displayStr;
